        ...
        <div className="flex h-full gap-3">
          ...
          >
            ...
            {mode === 'learn' && selectedVariation && (
              <div className="min-h-0 flex flex-col rounded-lg border border-white/10 overflow-hidden" style={{ flex: 1 }}>
                <MoveList
              ...
              <div className="min-h-0 flex flex-col rounded-lg border border-white/[0.14] overflow-hidden" style={{ flex: 1 }}>
