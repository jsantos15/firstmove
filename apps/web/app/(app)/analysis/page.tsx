                ...
                <div className="shrink-0 border-t border-white/5">
                  <div className="flex items-center gap-2 px-3 pt-2 pb-0.5">
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-1.5 rounded border border-amber-400/35 bg-amber-400/8 px-3 py-1.5 text-xs font-medium text-amber-300 transition-colors hover:border-amber-400/55 hover:bg-amber-400/15 hover:text-amber-200"
                    >
