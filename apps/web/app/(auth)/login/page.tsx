...
export default function LoginPage() {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      // Page will redirect via OAuth flow — no need to push manually
    } catch (err) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white hover:bg-white/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <GoogleIcon />
