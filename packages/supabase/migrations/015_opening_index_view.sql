-- Lightweight popularity-ranked opening list for web and mobile.
-- This exposes one row per learner-facing Lichess opening anchor and attaches
-- generated FirstMove course metadata when a matching course exists.
